document.addEventListener('DOMContentLoaded', function () {
    const assignments = [
        ...
        {
            title: 'Text-Editor',
            description: 'Using this you will learn to bold,italic and underline the text using javascript.',
            Date: '18-May-2024',
        ...
        {
            title: 'Calculator',
            description: 'This is a simple calculator in which basic operators are used(+,-,/,*)',
            Date: '10-May-2024',
        ...
        },
        {
            ...
            description: 'In this user enters his/her name if the user is on time (10 AM) the result shows that good but if the user is on(10.05 AM) the result shows be on time and be careful next time. If the user enters his/her name at after 10.05 AM the result shows that you are late your salary should be deducted!',
            Date: '4-May-2024',
        ...
        },
        {
            ...
            description: 'Enter your Date of Birth this app shows how many days,hours,seconds and many other things does you have spent from your Date Of Birth.',
            Date: '2-May-2024',
        ...
        {
            title: 'Dice Game',
            description: 'create your secret number and allow user to choose what is your secret number between 1 to 6 and at least give 2 chances  if his guess correct on first attempt give him 6 point else 3 point and if he dont guess he fail.',
            Date: '29-April-2024',
        ...
        {
            title: 'Colour Picker',
            description: 'An RGB color picker using JS is a tool that allows users to select and preview colors by adjusting red, green, and blue values dynamically with JavaScript.',
            Date: '27-April-2024',
